...
public class CarrinhoDTO {
    ...
    public static Set<CarrinhoDTO> converte(Set<Carrinho> carrinhos) {
        return carrinhos.stream().map(CarrinhoDTO::converte).collect(Collectors.toSet());
    }

    public static Set<Carrinho> converte(Set<CarrinhoDTO> carrinhos, Comprador comprador ) {
        return carrinhos.stream().map(carrinhoDTO -> converte(carrinhoDTO, comprador)).collect(Collectors.toSet());
    }
